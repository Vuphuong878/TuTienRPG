...
export const CHANGELOG_DATA: ChangelogEntry[] = [
  {
    ...
    changes: [
      ...
      { type: 'technical', text: 'OptimizedStorage.ts System - Comprehensive storage optimization utility với optimizeForStorage(), restoreFromStorage(), isOptimizedFormat(), và getCompressionStats(). Handles backward compatibility, compression metadata, và automatic detection of optimized save files.' },
      { type: 'technical', text: 'Intelligent Entity Merge Algorithm - Advanced intelligentEntityMerge() function preserves critical identity fields (referenceId, type, name) while intelligently merging skills arrays, enhancing descriptions, updating relationships, và allowing character progression without data loss.' },
      { type: 'technical', text: 'Comprehensive Test Suite - Added test-history-optimization.js và test-integration-comprehensive.js với realistic 20-turn gameplay scenarios. Tests verify 91.7% history reduction, 84.7% save file compression, entity deduplication accuracy, và system integration performance.' }
    ],
  },
  {
    version: '1.44.0',
